...
- Latest local tenant workspace UX update: `tenant.bookedai.au` has an enterprise console shell with sticky top bar, icon actions, desktop icon rail, sticky left menu, right content frame, and mobile bottom icon navigation; local frontend build and tenant gateway/workspace Playwright UAT (`5 passed`) passed on `2026-04-29`.
