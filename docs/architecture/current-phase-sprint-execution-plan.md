...
- `2026-04-26` public/pitch video replacement has been refreshed again: `bookedai.au` and `pitch.bookedai.au` now point their native pitch video embeds and direct video links to `https://upload.bookedai.au/videos/0cfb/LCpooAUVSsL24QXMvIBR0A.mp4`, with direct byte-range media verification returning `206 video/mp4`.
