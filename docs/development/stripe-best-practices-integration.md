...
- Portal/public return surfaces should query `GET /api/v1/payments/status` before showing Thank You/Paid. The homepage return surface now does this for Stripe success redirects.
...
Detailed follow-up review: `docs/development/stripe-payment-flow-review-2026-04-28.md`.

Stripe CLI webhook replay runbook: `docs/development/stripe-cli-webhook-replay-runbook.md`.
