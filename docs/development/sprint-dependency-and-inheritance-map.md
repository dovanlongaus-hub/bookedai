...
- Sprint 3 must implement that public baseline rather than reinterpret it
- Sprint 4 through Sprint 10 inherit the commercial vocabulary created by Sprint 1 through Sprint 3 and extend it into contracts, reporting, workflows, and hardening
...
| `Sprint 4` | Sprint 3 has preserved stable public CTA and source instrumentation |
...
| `Sprint 8` | Shared commercial reporting and workflow slices from Sprint 4 through Sprint 7 are available |
| `Sprint 9` | Shared commercial reporting and workflow slices from Sprint 4 through Sprint 7 are available |
| `Sprint 10` | Active widgets, workflows, and reporting flows from Sprint 4 through Sprint 9 exist |
...
| `Sprint 4` | Sprint 1 to Sprint 3 public vocabulary and CTA or source instrumentation baseline | shared commercial vocabulary across public, tenant, and admin | should start after Sprint 3 instrumentation shape is stable |
...
| `Sprint 8` | Sprint 4 through Sprint 7 shared contracts and workflow states | tenant-safe vocabulary, action-oriented tenant views, no internal-only controls | can run in parallel with Sprint 9 |
| `Sprint 9` | Sprint 4 through Sprint 7 shared contracts and workflow states | admin issue taxonomy, auditability, investigation-safe controls | can run in parallel with Sprint 8 |
| `Sprint 10` | Sprint 4 through Sprint 9 active widgets and workflows | release truth, regression scope, rollback clarity | should follow the first usable tenant and admin flows |
...
- `Sprint 8` and `Sprint 9` can run in parallel
...
- `Sprint 10` is a hardening sprint for the earlier commercial system and should usually close before the Phase 7-8 rollout is treated as stable
