...
## Ongoing closeout rule

For future updates, do not treat Notion as a one-off export destination only.

Each meaningful delivery should also:

1. update the changed requirement-facing document in the repo
2. update `docs/development/implementation-progress.md`
3. update the matching sprint, roadmap, or phase artifact
4. publish the detailed note through:
...
5. use:
   ...
   when a broader documentation refresh needs to be published into the live BookedAI Notion workspace

Channel split:

- Discord should receive the short summary text directly in the message body
- Notion should receive the detailed document, longer rationale, and full execution context
