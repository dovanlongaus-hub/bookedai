# Public search and booking flow upgrade, 2026-04-23

- Timestamp: 2026-04-23T09:36:24.750182+00:00
- Source: telegram
...
Shipped today’s public-flow upgrade: hardened Continue booking with safe fallback when live v1 writes degrade, tightened homepage and assistant matching states into clearer English-first progress steps, improved next-action focus across search, selection, and booking details, and synced the implementation/results across project, sprint, architecture, and dedicated execution-note docs.
