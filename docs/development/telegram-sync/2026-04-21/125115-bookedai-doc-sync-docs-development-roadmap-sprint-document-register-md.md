# BookedAI doc sync - docs/development/roadmap-sprint-document-register.md

- Timestamp: 2026-04-21T12:51:15.936371+00:00
...
Synchronized `docs/development/roadmap-sprint-document-register.md` from the BookedAI repository into the Notion workspace. Preview: # Roadmap Sprint Document Register Date: `2026-04-21` ## Purpose This register maps each active roadmap sprint to the source documents that define the current BookedAI delivery plan.

## Details

Source path: docs/development/roadmap-sprint-document-register.md
Synchronized at: 2026-04-21T12:51:15.788107+00:00
