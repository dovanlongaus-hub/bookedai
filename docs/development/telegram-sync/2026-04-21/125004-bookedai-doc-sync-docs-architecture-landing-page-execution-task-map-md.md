# BookedAI doc sync - docs/architecture/landing-page-execution-task-map.md

- Timestamp: 2026-04-21T12:50:04.559711+00:00
...
Synchronized `docs/architecture/landing-page-execution-task-map.md` from the BookedAI repository into the Notion workspace. Preview: # BookedAI Landing Page Execution Task Map Date: `2026-04-17` Document status: `active sprint-2 and sprint-3 execution map` ## 1. Purpose

## Details

Source path: docs/architecture/landing-page-execution-task-map.md
Synchronized at: 2026-04-21T12:50:04.333283+00:00
