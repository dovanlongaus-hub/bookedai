# BookedAI doc sync - docs/architecture/jira-epic-story-task-structure.md

- Timestamp: 2026-04-21T12:50:02.627726+00:00
...
Synchronized `docs/architecture/jira-epic-story-task-structure.md` from the BookedAI repository into the Notion workspace. Preview: # BookedAI Jira Epic Story Task Structure ## Purpose This document converts the implementation roadmap into a Jira-friendly hierarchy using: - Epic

## Details

Source path: docs/architecture/jira-epic-story-task-structure.md
Synchronized at: 2026-04-21T12:50:02.468949+00:00
