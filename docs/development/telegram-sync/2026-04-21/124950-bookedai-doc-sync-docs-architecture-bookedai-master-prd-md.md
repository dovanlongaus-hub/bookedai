# BookedAI doc sync - docs/architecture/bookedai-master-prd.md

- Timestamp: 2026-04-21T12:49:50.117884+00:00
...
Synchronized `docs/architecture/bookedai-master-prd.md` from the BookedAI repository into the Notion workspace. Preview: # BookedAI Product Requirements Document Date: `2026-04-18` Document status: `active planning baseline` ## 1. Document purpose

## Details

Source path: docs/architecture/bookedai-master-prd.md
Synchronized at: 2026-04-21T12:49:49.968929+00:00
