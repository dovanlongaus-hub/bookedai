# BookedAI doc sync - docs/development/future-swim-tenant-use-case.md

- Timestamp: 2026-04-21T12:50:53.915441+00:00
...
Synchronized `docs/development/future-swim-tenant-use-case.md` from the BookedAI repository into the Notion workspace. Preview: # Future Swim Tenant Use Case Date: `2026-04-20` Document status: `active tenant-specific implementation reference` ## 1. Purpose

## Details

Source path: docs/development/future-swim-tenant-use-case.md
Synchronized at: 2026-04-21T12:50:53.595239+00:00
