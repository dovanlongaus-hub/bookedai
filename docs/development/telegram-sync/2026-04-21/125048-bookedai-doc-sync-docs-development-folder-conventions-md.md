# BookedAI doc sync - docs/development/folder-conventions.md

- Timestamp: 2026-04-21T12:50:48.986002+00:00
...
Synchronized `docs/development/folder-conventions.md` from the BookedAI repository into the Notion workspace. Preview: # BookedAI Folder Conventions ## Purpose This note explains how new code should be placed in the current BookedAI repo without forcing a rewrite. ## Backend placement

## Details

Source path: docs/development/folder-conventions.md
Synchronized at: 2026-04-21T12:50:48.753508+00:00
