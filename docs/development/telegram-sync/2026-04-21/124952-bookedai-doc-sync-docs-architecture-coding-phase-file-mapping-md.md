# BookedAI doc sync - docs/architecture/coding-phase-file-mapping.md

- Timestamp: 2026-04-21T12:49:52.833146+00:00
...
Synchronized `docs/architecture/coding-phase-file-mapping.md` from the BookedAI repository into the Notion workspace. Preview: # BookedAI Coding Phase File Mapping ## Purpose This document maps the coding implementation phases directly onto the current repository files and folders so engineering teams can see exactly where each phase should be implemented. It should be read together with:

## Details

Source path: docs/architecture/coding-phase-file-mapping.md
Synchronized at: 2026-04-21T12:49:52.522416+00:00
