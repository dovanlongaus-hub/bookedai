# BookedAI doc sync - docs/development/bookedai-chatbot-landing-implementation-plan.md

- Timestamp: 2026-04-21T12:50:44.836056+00:00
...
Synchronized `docs/development/bookedai-chatbot-landing-implementation-plan.md` from the BookedAI repository into the Notion workspace. Preview: # BookedAI.au Chatbot Landing Page UI Section Plan ## Objective Translate the new landing-page design direction into an implementation-ready plan that fits the current Next.js component structure. ## Current Baseline

## Details

Source path: docs/development/bookedai-chatbot-landing-implementation-plan.md
Synchronized at: 2026-04-21T12:50:44.684431+00:00
