# BookedAI doc sync - docs/architecture/public-growth-app-strategy.md

- Timestamp: 2026-04-21T12:50:28.448569+00:00
...
Synchronized `docs/architecture/public-growth-app-strategy.md` from the BookedAI repository into the Notion workspace. Preview: # Public Growth App Strategy ## Purpose This document defines the official Prompt 6-level strategy for the public growth surface of `BookedAI.au`. It is written for a production system that is already live.

## Details

Source path: docs/architecture/public-growth-app-strategy.md
Synchronized at: 2026-04-21T12:50:28.183682+00:00
