# BookedAI doc sync - README.md

- Timestamp: 2026-04-21T12:48:38.089303+00:00
...
Synchronized `README.md` from the BookedAI repository into the Notion workspace. Preview: # BookedAI BookedAI is a Docker-based full-stack application for the `bookedai.au` domain, built around the product direction `BookedAI - The AI Revenue Engine for Service Businesses`, with self-hosted Supabase, n8n, and Hermes running on the same Docker host. Current application release baseline: `1.0.1-stable`. ## Repository structure

## Details

Source path: README.md
Synchronized at: 2026-04-21T12:48:37.938845+00:00
