# BookedAI doc sync - docs/architecture/internal-admin-app-strategy.md

- Timestamp: 2026-04-21T22:59:48.400135+00:00
...
Synchronized `docs/architecture/internal-admin-app-strategy.md` from the BookedAI repository into the Notion workspace. Preview: # Internal Admin App Strategy ## Purpose This document defines the official Prompt 8-level strategy for the internal BookedAI admin app and ops console. It is written for a production system that is already running.

## Details

Source path: docs/architecture/internal-admin-app-strategy.md
Synchronized at: 2026-04-21T22:59:48.228815+00:00
