# BookedAI doc sync - docs/development/release-gate-checklist.md

- Timestamp: 2026-04-21T12:51:14.465422+00:00
...
Synchronized `docs/development/release-gate-checklist.md` from the BookedAI repository into the Notion workspace. Preview: # Release Gate Checklist ## Purpose This checklist turns the current local release gate into a clear promote, hold, or rollback decision. Primary gate command:

## Details

Source path: docs/development/release-gate-checklist.md
Synchronized at: 2026-04-21T12:51:14.141713+00:00
