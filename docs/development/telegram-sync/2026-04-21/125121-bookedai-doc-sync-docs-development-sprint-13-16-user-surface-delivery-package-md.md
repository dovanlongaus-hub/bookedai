...
- Timestamp: 2026-04-21T12:51:21.034167+00:00
...
Synchronized at: 2026-04-21T12:51:20.883898+00:00
...
8. `Portal architecture and design spec screens`
   - booking review
   - payment state
   - reschedule request
   - cancel request
...
4. `Portal booking detail read seam`
   - recommended path:
     - `GET /api/v1/portal/bookings/{booking_reference}`
5. `Portal allowed-actions model`
   - reschedule allowed
   - cancel allowed
   - payment required
...
2. expose billing seams in backend contracts
3. refine tenant workspace home
4. add admin support panels
5. define and approve first portal screen contract
...
3. add portal allowed actions
4. implement invoice and payment-method screens
5. add tenant value summary
6. add regression coverage for portal and billing paths
