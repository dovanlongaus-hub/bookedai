# BookedAI doc sync - docs/architecture/frontend-theme-design-token-map.md

- Timestamp: 2026-04-21T12:49:58.489700+00:00
...
Synchronized `docs/architecture/frontend-theme-design-token-map.md` from the BookedAI repository into the Notion workspace. Preview: # BookedAI Frontend Theme Design Token Map Date: `2026-04-17` Document status: `active sprint-2 implementation source` Companion strategic theme document:

## Details

Source path: docs/architecture/frontend-theme-design-token-map.md
Synchronized at: 2026-04-21T12:49:58.220317+00:00
