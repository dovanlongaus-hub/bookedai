# BookedAI doc sync - docs/development/release-note-2026-04-20-homepage-product-live.md

- Timestamp: 2026-04-21T12:51:15.278794+00:00
...
Synchronized `docs/development/release-note-2026-04-20-homepage-product-live.md` from the BookedAI repository into the Notion workspace. Preview: # BookedAI Release Note - 2026-04-20 Document status: `live release note` ## Release summary This release tightens the public acquisition surface on `bookedai.au`, aligns package language across the live public stack, and keeps homepage trial intent pointed into the real product runtime on `product.bookedai.au`.

## Details

Source path: docs/development/release-note-2026-04-20-homepage-product-live.md
Synchronized at: 2026-04-21T12:51:15.033202+00:00
