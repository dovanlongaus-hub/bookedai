# BookedAI doc sync - docs/development/env-strategy.md

- Timestamp: 2026-04-21T12:50:48.013609+00:00
...
Synchronized `docs/development/env-strategy.md` from the BookedAI repository into the Notion workspace. Preview: # BookedAI Environment Strategy Date: `2026-04-21` ## Purpose This note explains how environment variables are organized in the current production-safe repo and which variables are now considered the approved runtime baseline.

## Details

Source path: docs/development/env-strategy.md
Synchronized at: 2026-04-21T12:50:47.864567+00:00
