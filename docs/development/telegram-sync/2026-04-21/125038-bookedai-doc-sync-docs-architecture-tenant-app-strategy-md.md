# BookedAI doc sync - docs/architecture/tenant-app-strategy.md

- Timestamp: 2026-04-21T12:50:38.768625+00:00
...
Synchronized `docs/architecture/tenant-app-strategy.md` from the BookedAI repository into the Notion workspace. Preview: # Tenant App Strategy ## Purpose This document defines the official Prompt 7-level strategy for the BookedAI tenant-facing application. It is written for a production system that is already running.

## Details

Source path: docs/architecture/tenant-app-strategy.md
Synchronized at: 2026-04-21T12:50:38.501618+00:00
