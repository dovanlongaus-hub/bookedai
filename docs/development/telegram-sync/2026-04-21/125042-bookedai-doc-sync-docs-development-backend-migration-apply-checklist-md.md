# BookedAI doc sync - docs/development/backend-migration-apply-checklist.md

- Timestamp: 2026-04-21T12:50:42.939797+00:00
...
Synchronized `docs/development/backend-migration-apply-checklist.md` from the BookedAI repository into the Notion workspace. Preview: # BookedAI Backend Migration Apply Checklist Date: `2026-04-18` Document status: `active execution checklist` ## Purpose

## Details

Source path: docs/development/backend-migration-apply-checklist.md
Synchronized at: 2026-04-21T12:50:42.785600+00:00
