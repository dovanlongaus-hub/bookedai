# BookedAI doc sync - docs/architecture/landing-page-system-requirements.md

- Timestamp: 2026-04-21T12:50:05.202800+00:00
...
Synchronized `docs/architecture/landing-page-system-requirements.md` from the BookedAI repository into the Notion workspace. Preview: # BookedAI Landing Page System Requirements Date: `2026-04-18` Document status: `active phase-0 source of truth` ## 1. Purpose

## Details

Source path: docs/architecture/landing-page-system-requirements.md
Synchronized at: 2026-04-21T12:50:05.054668+00:00
