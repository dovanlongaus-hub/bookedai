# BookedAI doc sync - docs/governance/change-governance.md

- Timestamp: 2026-04-21T12:51:46.509873+00:00
...
Synchronized `docs/governance/change-governance.md` from the BookedAI repository into the Notion workspace. Preview: # BookedAI Change Governance ## Purpose This document defines how BookedAI must be changed going forward so that upgrades remain synchronized across product, platform, and documentation layers. ## Mandatory Change Workflow

## Details

Source path: docs/governance/change-governance.md
Synchronized at: 2026-04-21T12:51:46.296570+00:00
