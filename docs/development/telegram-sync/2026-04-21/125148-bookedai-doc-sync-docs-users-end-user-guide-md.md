# BookedAI doc sync - docs/users/end-user-guide.md

- Timestamp: 2026-04-21T12:51:48.194225+00:00
...
Synchronized `docs/users/end-user-guide.md` from the BookedAI repository into the Notion workspace. Preview: # BookedAI End User Guide ## Audience This guide is for the person visiting `bookedai.au` to discover services, chat with the assistant, and submit a booking or consultation request. ## What the End User Sees

## Details

Source path: docs/users/end-user-guide.md
Synchronized at: 2026-04-21T12:51:48.024946+00:00
