# BookedAI doc sync - docs/architecture/unified-responsive-theme-system.md

- Timestamp: 2026-04-21T12:50:39.489370+00:00
...
Synchronized `docs/architecture/unified-responsive-theme-system.md` from the BookedAI repository into the Notion workspace. Preview: # BookedAI Unified Responsive Theme System Date: `2026-04-18` Status: `active canonical design direction` Reference analyzed:

## Details

Source path: docs/architecture/unified-responsive-theme-system.md
Synchronized at: 2026-04-21T12:50:39.333811+00:00
