# Superseded Customer Agent Naming

- Timestamp: 2026-04-26T10:59:37.461006+00:00
...
This earlier naming note was superseded on 2026-04-26. The customer-facing chat automation agent is now `BookedAI Manager Bot`, with Telegram display name `BookedAI Manager Bot` and preferred username `@BookedAI_Manager_Bot`. This name remains separate from OpenClaw/operator Telegram tooling.
