# BookedAI Zoho CRM live connection activated

- Timestamp: 2026-04-22T07:49:20.470658+00:00
- Source: docs/development/project-update-2026-04-22-zoho-crm-live-connected.md
- Category: development-update
- Status: active

## Summary

BookedAI Zoho CRM is now live-connected for the AU tenant. The repo-local runtime now has real client credentials plus refresh-token posture, and direct smoke testing against Leads returned status connected with the expected CRM module and field metadata.
