...
- Timestamp: 2026-04-22T10:00:51.524869+00:00
- Source: codex
...
Tenant login now moves to email-first auth: email code sign-in/create/claim is implemented, Google stays on the same tenant login form, and legacy username/password is kept only as compatibility fallback.
