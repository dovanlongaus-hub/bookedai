...
- Timestamp: 2026-04-25T05:56:57.395700+00:00
- Source: codex
...
Added and deployed the OpenClaw/Telegram whatsapp-bot-status readiness command for the BookedAI WhatsApp bot. It verifies bot.bookedai.au, API health, WhatsApp provider connectivity, and webhook verify-route reachability without sending customer messages; live OpenClaw CLI now includes whatsapp_bot_status in the allowed action set.
