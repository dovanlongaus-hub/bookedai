# Public homepage redesign deployed live

- Timestamp: 2026-04-25T13:11:59.762323+00:00
- Source: scripts/healthcheck_stack.sh
- Category: product-surface
- Status: completed

## Summary

Deployed the redesigned bookedai.au homepage live, verified production title/H1/nav/mobile no-overflow/clean console, and updated stack health checks so root bookedai.au is expected to serve the homepage directly while pitch.bookedai.au remains the deeper investor surface.
