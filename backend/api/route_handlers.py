...
async def admin_config(
    ...
    raw_items: list[tuple[str, str, str, bool]] = [
        ...
        ("ANTHROPIC_API_KEY", cfg.anthropic_api_key, "AI Provider", True),
        ("ANTHROPIC_BASE_URL", cfg.anthropic_base_url, "AI Provider", False),
        ("ANTHROPIC_MODEL", cfg.anthropic_model, "AI Provider", False),
