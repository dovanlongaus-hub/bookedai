...
AUTO_DNS_RECORDS="${CLOUDFLARE_AUTO_DNS_RECORDS:-bookedai.au,www.bookedai.au,api.bookedai.au,admin.bookedai.au,n8n.bookedai.au,supabase.bookedai.au,hermes.bookedai.au,upload.bookedai.au}"
PROXIED_DNS_RECORDS="${CLOUDFLARE_AUTO_DNS_PROXIED_RECORDS:-bookedai.au,www.bookedai.au,api.bookedai.au,admin.bookedai.au,n8n.bookedai.au,supabase.bookedai.au,hermes.bookedai.au}"
