...
echo "DNS must already point ${DOMAIN_ROOT}, ${DOMAIN_WWW}, ${DOMAIN_API}, ${DOMAIN_PRODUCT}, ${DOMAIN_DEMO}, ${DOMAIN_FUTURESWIM}, ${DOMAIN_CHESS}, ${DOMAIN_AIMENTOR}, ${DOMAIN_PORTAL}, ${DOMAIN_TENANT}, ${DOMAIN_PITCH}, ${DOMAIN_N8N}, ${DOMAIN_SUPABASE}, ${DOMAIN_UPLOAD}, ${DOMAIN_CALENDAR}, ${DOMAIN_BOT} to this server."
echo "Next step:"
