...
export function ProductApp() {
  return (
    <main className="booked-shell booked-product-shell min-h-screen min-h-[100svh] overflow-x-hidden md:min-h-[100dvh]">
      <section className="relative flex h-full min-h-[100svh] flex-col overflow-hidden md:min-h-[100dvh]">
        ...
        <div className="relative z-10 flex items-center justify-between gap-2 px-3 py-2 pt-[calc(env(safe-area-inset-top)+0.45rem)] sm:px-5 sm:pb-2 sm:pt-[calc(env(safe-area-inset-top)+0.9rem)] lg:px-6">
          <div className="flex min-w-0 items-center gap-2 sm:gap-3">
            <LogoMark
              alt={brandName}
              className="booked-brand-image booked-brand-image--soft h-7 w-7 shrink-0 sm:h-8 sm:w-8"
            />
            <div className="min-w-0">
              <div className="line-clamp-1 text-[12px] font-semibold tracking-tight text-slate-950 sm:text-sm">
                {brandName}
              </div>
              <div className="text-[10px] text-slate-500">Live demand-to-booking flow</div>
            </div>
          ...
          <div className="flex shrink-0 items-center gap-1.5">
            <div className="flex items-center gap-1.5 rounded-full bg-emerald-50 px-2 py-1 sm:px-2.5">
            ...
            <a
              ...
              className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-slate-200 bg-white text-[12px] font-semibold text-slate-700 shadow-[0_10px_22px_rgba(15,23,42,0.06)] transition hover:border-slate-300 hover:bg-slate-50 sm:hidden"
            >
              ←
            </a>
        ...
        <div className="relative z-10 hidden px-3 pb-2 sm:block sm:px-5">
          <div className="mx-auto flex max-w-[32rem] items-center justify-between rounded-full border border-white/70 bg-white/82 px-3 py-2 shadow-[0_12px_30px_rgba(15,23,42,0.06)] backdrop-blur">
            <div className="min-w-0">
            ...
            <div className="hidden rounded-full bg-slate-100 px-3 py-1 text-[10px] font-semibold text-slate-600 sm:block">
              Mobile-ready
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 flex min-h-0 flex-1 items-stretch justify-center px-0 pb-0 sm:px-3 sm:pb-3 lg:px-4 lg:pb-4">
          <div className="flex min-h-0 w-full max-w-[28rem] flex-1 items-stretch lg:max-w-[24rem]">
