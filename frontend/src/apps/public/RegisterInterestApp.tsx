...
const offerPackages: Array<{
...
}> = [
  {
    ...
    backendPlanId: 'basic',
    icon: BadgeCheck,
    headline: 'Solo or micro team launching one clean booking path.',
    body: 'One booking-ready page, one channel, one service catalog, BookedAI Manager Bot, portal, payment QR posture, and email confirmations.',
    commissionNote: 'A$0 setup, A$79/mo, 0% commission.',
  },
  {
    id: 'growth',
    title: 'Grow',
    ...
    icon: Rocket,
    headline: 'Established business ready for managed multi-channel bookings.',
    body: 'Web, Telegram, WhatsApp, booking-care queue, payment posture, CRM sync, booking activity history, and a revenue summary.',
    commissionNote: 'A$499 onboarding plus 3% on captured booked revenue.',
    highlighted: true,
  },
  {
    id: 'enterprise',
    ...
    backendPlanId: 'pro',
    icon: Building2,
    headline: 'Multi-location, franchise, academy, or platform rollout.',
    body: 'Templates, SSO/API, white-label widget, retention automation, SLA, reporting, and a named success owner.',
    commissionNote: 'Custom setup plus attributable revenue model scoped up front.',
  },
];
