...
export function getHomepageContent(locale: HomepageLocale): HomepageContent {
  ...
  return {
    ...
    ui: {
      ...
      noMatchBody: 'BookedAI stays precise instead of forcing a weak recommendation.',
      geoHint: 'For tighter local matching, add your suburb or area.',
