  ...
  return (
    <section id="audit-events" className="template-card p-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <h2 className="template-title mt-3 text-2xl font-semibold text-[#1d1d1f]">
            Reconstruct what happened before the team escalates or edits anything
          </h2>
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <SummaryCard label="Team actions" value={`${summary.operatorActions}`} detail="Queue items already opened, reviewed, or escalated by the team." />
